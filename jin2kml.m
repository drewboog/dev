...
% log file in:
fileName = '/Users/hazlet26/Desktop/ForthFiles/results/sflog6-out2.log';
...
while ~feof(fid) ;
    ...
    if (N==fullN)
       dataStore(i,1:15) = dataLine(1:15);
       i = i+1;
    end  
...
% hour,min,sec,lat,lon,altE,hdg,spd,hAcc,vAcc,hdgAcc,spdAcc,fixType,numSvs,hdop
    %style = 'purple';
    hour = num2str(dataLine(1),15);
    min = num2str(dataLine(2),15);
    sec = num2str(dataLine(3),15);
    lat = num2str(dataLine(4),15);
    lon = num2str(dataLine(5),15);
    altE = num2str(dataLine(6),15);
    hdg = num2str(dataLine(7),15);
    spd = num2str(dataLine(8),15);
    hAcc = num2str(dataLine(9),15);
    vAcc = num2str(dataLine(10),15);
    hdgAcc = num2str(dataLine(11),15);
    spdAcc = num2str(dataLine(12),15);
    fixType = num2str(dataLine(13),15);
    numSvs = num2str(dataLine(14),15);
    hdop = num2str(dataLine(15),15);
